...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_two_states_unique_ids(self):
        stat1 = State()
        stat2 = State()
        self.assertNotEqual(stat1.id, stat2.id)

    def test_two_states_different_created_at(self):
        stat1 = State()
        sleep(0.05)
        stat2 = State()
        self.assertLess(stat1.created_at, stat2.created_at)

    def test_two_states_different_updated_at(self):
        stat1 = State()
        sleep(0.05)
        stat2 = State()
        self.assertLess(stat1.updated_at, stat2.updated_at)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        self.assertEqual(stat.created_at, dt)
        self.assertEqual(stat.updated_at, dt)
